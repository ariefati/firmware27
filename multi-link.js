...
j++;}
if(a_to_vh==false)
{var encryptedUrl=Base64.encode(a_to_vi);var x=Math.floor((Math.random()*11)+ 1);var xxx=null;
...
if(x=="10"){xxx="/2018/01/best-smartphone-for-video.html"}
if(x=="11"){xxx="/2018/04/vivo-v9-spesification.html"}a_to_ve[i].href="http://cloud.fw27.xyz"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
